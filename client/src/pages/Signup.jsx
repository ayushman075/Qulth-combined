...
const Signup = () => {
  const { register, googleLogin, isSignedIn } = useAuthData(); // Assuming `signUp` function is in `useAuth`
  ...
  const handleSignup =async () => {
    if (!email || !password || !confirmPassword) {
      ...
      toast.error("Passwords do not match");
        ...
        toast.error("Passwords should atleast be 8 characters");
    } else {
...
>
    ...
    <div className="flex-col w-1/2 m-auto max-md:w-full justify-center items-center">
      <Card className=" bg-gradient-to-br from-[rgb(199,245,165)] to-[#c7f5a5] rounded-xl p-0 shadow-lg ">
